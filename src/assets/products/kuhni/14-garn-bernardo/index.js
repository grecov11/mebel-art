...
export const garnBernardo = [
    {
        ...
        description: "КОРПУС: ЛДСП «Серый» ЛДСП EGGER «H3176 Дуб Галифакс олово»"
    },
    {
        img: img2,
        title: "КУХОННЫЙ ГАРНИТУР БЕРНАРДО",
        description: "ФАСАД: МДФ «GL-11 Light Grey» МДФ «ST-17 Dark Olive»"
    },
    {
        img: img3,
        title: "КУХОННЫЙ ГАРНИТУР  БЕРНАРДО",
    ...
    },
    {
        img: img4,
        title: "КУХОННЫЙ ГАРНИТУР  БЕРНАРДО",
        description: "СТОЛЕШНИЦА: 38 мм Кедр «3030 / ТИ Мрамор маркв черный»"
    },
    {
        img: img5,
        title: "КУХОННЫЙ ГАРНИТУР  БЕРНАРДО",
